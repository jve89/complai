...
/**
 * Minimal on/off switch — a styled button with `role="switch"`, no extra
 * dependency. Controlled: pass `checked` + `onCheckedChange`. `bg-primary`
 * (brand indigo) when on, `bg-input` when off.
 */
