...
const CLASSIFICATION_STEPS: WizardStep[] = [
  ...
  },
  {
    ...
    section: "Producten",
    title: "Wordt dat product vóór verkoop door een externe instantie gekeurd?",
    help: "Sommige gereguleerde producten moeten vóór de CE-markering door een 'aangemelde instantie' (een onafhankelijke derde partij) worden beoordeeld — dan is de ingebouwde AI hoog-risico (Art. 6(1)). Weet u het niet zeker? Kies gerust 'Weet ik niet'.",
    type: "single",
  ...
  },
  {
    ...
    help: "Dit is de wettelijke lijst met hoog-risico toepassingen (bijlage III van de AI Act). Kies alles wat past — of 'Geen van bovenstaande'.",
    type: "multi",
